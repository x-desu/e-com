...
const GiftCouponCard = () => {
  ...
  useEffect(() => {
    if (!coupon && isCouponApplied) getMyCoupon();
  }, [getMyCoupon, coupon, isCouponApplied]);
    ...
    >
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <motion.button
            type="button"
            className="flex  sm:w-full items-center justify-center rounded-lg bg-emerald-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-emerald-700 focus:outline-none focus:ring-4 focus:ring-emerald-300"
